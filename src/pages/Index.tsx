          ...
          <TabsContent value="dashboard" className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
              ...
              <Card className="bg-gradient-to-r from-blue-600 to-blue-800 text-white">
                ...
                <CardContent>
                  <div className="text-2xl font-bold">
                    {dashboardStats.monthlyRevenue.toLocaleString()} SSP
                  </div>
                  <Badge className="mt-2 text-white border-white bg-transparent">
                    {dashboardStats.pendingPayments.toLocaleString()} SSP{' '}
                    {t.pendingPayments}
                  </Badge>
                </CardContent>
              </Card>
                ...
                <CardContent>
                  <div className="space-y-1">
                    <div className="text-sm">
                      {dashboardStats.overdueAccounts} {t.overdueAccounts}
                    </div>
                    <div className="text-sm">
                      {dashboardStats.fupViolations} {t.fupViolations}
                    </div>
                    <div className="text-sm">
                      {dashboardStats.equipmentIssues} {t.equipmentIssues}
                    </div>
                  </div>
                </CardContent>
              </Card>
              ...
              <Card>
                <CardHeader>
                  <CardTitle className="text-sm">
                    {t.mobileMoneyPayments}
                  </CardTitle>
                </CardHeader>
                <CardContent>
                  <div className="text-2xl font-bold text-blue-600">
                    {dashboardStats.mobileMoneyPayments}%
                  </div>
