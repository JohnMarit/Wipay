    ...
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Available internet service plans and pricing</CardDescription>
        </CardHeader>
        <CardContent>
              ...
              <Card key={plan.id} className="border-2 hover:border-blue-200 transition-colors">
                ...
                <CardContent>
                  <div className="space-y-3">
                    ...
                    <div className="flex justify-between items-center">
                      <span className="text-sm text-gray-500">{t.activeUsers}</span>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Monitor and manage customer equipment</CardDescription>
        </CardHeader>
        <CardContent>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Real-time bandwidth usage monitoring</CardDescription>
        </CardHeader>
        <CardContent>
          <div className="space-y-6">
            {bandwidthUsage.map((usage, index) => (
              <div key={index} className="border rounded-lg p-4">
                <div className="flex justify-between items-start mb-3">
                  ...
                  <Badge variant={usage.percentage > 80 ? "destructive" : "default"}>
                    {usage.percentage}%
                  </Badge>
                </div>
                <div className="space-y-2">
                  <div className="flex justify-between text-sm">
                    <span>{t.currentUsage}: {usage.used} GB</span>
                    <span>{t.limit}: {usage.limit} GB</span>
                  </div>
