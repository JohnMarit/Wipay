...
import { Calendar, Receipt, DollarSign, Clock, AlertCircle, FileText, Bell, Calculator } from "lucide-react";
...
const EnhancedBillingModule = ({ language }: EnhancedBillingModuleProps) => {
  ...
  const customers = [
    { name: "Ahmed Hassan Mohamed", planType: "postpaid", phone: "+211912345678" },
    { name: "Mary John Deng", planType: "prepaid", phone: "+211923456789" },
    { name: "Peter Garang Mabior", planType: "postpaid", phone: "+211934567890" }
  ];
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold text-red-600">{billingStats.overdueAmount.toLocaleString()} SSP</div>
        ...
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium">{t.generateInvoice}</CardTitle>
      ...
      <Card>
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <div className="text-center p-4 border rounded-lg">
              <div className="text-2xl font-bold text-red-600">{billingStats.aging.days90plus.toLocaleString()}</div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Complete invoice management with automated features</CardDescription>
        </CardHeader>
        <CardContent>
              ...
              <TableBody>
                {invoices.map((invoice) => (
                  <TableRow key={invoice.id}>
                    ...
                    <TableCell>
                      <Badge variant={invoice.planType === 'prepaid' ? 'default' : 'secondary'}>
                        {invoice.planType === 'prepaid' ? t.prepaid : t.postpaid}
                      </Badge>
                    </TableCell>
